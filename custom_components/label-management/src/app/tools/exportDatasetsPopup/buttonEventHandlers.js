...
import { downloadCOCOJSON, saveCOCOJSONToDB, approveAnnotationToDB } from './fileTypes/COCOJSON';
...
function approveAnnotation() {
  approveAnnotationToDB();
}
export {
  selectDatasetExportFormat, exportDatasets, closeexportDatasetsPopup, saveData, approveAnnotation,
};
