...
from components.operation_management_component import operation_management_component
import json
from streamlit_autorefresh import st_autorefresh

 # cookies_manager.initialize_cookie_session()
 # Safe auto-refresh logic
# PAGE_KEY = "operation_management_page_loaded"
...
with page_placeholder.container():
    ...
    def render_componet(): 
        ...
        st.markdown("""
            ...
            iframe[title="components.operation_management_component.operation_management_component"] {
        ...
        if token:
            ...
            response = operation_management_component(data=auth_data, key="data-mgnt-compt")
            time.sleep(1)
            # if response:
    ...
    def render_operation_management():
