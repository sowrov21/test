...
from components.upload_management_component import upload_management_component
import json
from streamlit_autorefresh import st_autorefresh
 # cookies_manager.initialize_cookie_session()
 # Safe auto-refresh logic
# PAGE_KEY = "upload_management_page_loaded"
...
with page_placeholder.container():
    ...
    def render_componet(): 
        ...
        st.markdown("""
            ...
            iframe[title="components.upload_management_component.upload_management_component"] {
        ...
        if token:
            ...
            response = upload_management_component(data=auth_data, key="data-mgnt-compt")
            time.sleep(1)
            #if response:
                # if response.get("message") == "Token_Refreshed":
